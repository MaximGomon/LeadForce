<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="KnowledgeBase.aspx.cs" Inherits="WebCounter.AdminPanel.KnowledgeBase" %>
                    ...
                    <telerik:RadPanelBar ID="RadPanelBar1" Width="189px" Skin="Windows7" runat="server">
                        <Items>
                            <telerik:RadPanelItem Expanded="true" Text="Теги">
                                <ContentTemplate>
                                    <labitec:Tags ID="tagsPublication" ObjectTypeName="tbl_Publication" runat="server" />
                                </ContentTemplate>
                ...
                <div>
                   <asp:ValidationSummary ID="ValidationSummary" DisplayMode="BulletList" 
                    ...
                    <div class="left-column">
		                ...
		                <div class="row">
			                <label>Автор:</label>
                            <uc:ContactComboBox ID="ucAuthor" CssClass="select-text" runat="server" FilterByFullName="true"/>
                ...
                --%>	<telerik:RadTabStrip ID="RadTabStrip1" MultiPageID="RadMultiPage1" SelectedIndex="0" runat="server">
	                ...
	                <telerik:RadMultiPage ID="RadMultiPage1" SelectedIndex="0" CssClass="multiPage" runat="server" Width="920px">
	                    <telerik:RadPageView runat="server" CssClass="clearfix">
	                        <br/>	                        
                            <div class="row">
                                <uc:HtmlEditor runat="server" ID="ucHtmlEditor" Width="917px" Height="400px" Module="KnowledgeBases" />
                            </div>	                        
	                    </telerik:RadPageView>
