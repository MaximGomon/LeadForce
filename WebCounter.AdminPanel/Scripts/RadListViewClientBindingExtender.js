...
(function () {
    ...
    $T.RadListViewClientBindingExtender.prototype = {
        ...
        _loadData: function () {
            ...
            var argumentsObject = { startIndex: this._currentPageIndex++, publicationType: $('#hfPublicationType').val(), publicationCategory: $('#hfPublicationCategory').val(), filter: $('#hfPublicationFilter').val() };
            try {
                $telerik.$.ajax({
                    type: "POST",
                    url: url,
