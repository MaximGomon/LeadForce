...
{
    public partial class SelectSiteActionTemplate : LeadForceWizardStep
    {        
        /// <summary>
        /// Binds the data.
        /// </summary>
        public override void BindData()
        {
            ...
            BindSiteActionTemplates(CurrentSiteTemplate);
        }
        ...
        private void BindSiteActionTemplates(Guid siteId)
        {            
            rlbSource.DataSource = DataManager.SiteActionTemplate.SelectAll(siteId);
        ...
        {
            e.Item.Text = string.Format("Шаблон сообщения '{0}' из шаблона '{1}'", e.Item.Text, ucSiteTemplateComboBox.SelectedText);
