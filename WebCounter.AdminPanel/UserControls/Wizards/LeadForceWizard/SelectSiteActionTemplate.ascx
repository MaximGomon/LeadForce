<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SelectSiteActionTemplate.ascx.cs" Inherits="WebCounter.AdminPanel.UserControls.Wizards.LeadForceWizard.SelectSiteActionTemplate" %>
...
<div class="wizard-step">
    <h3>Выбор шаблонов сообщений</h3>
    <div class="row">
        <label>Шаблон</label>
