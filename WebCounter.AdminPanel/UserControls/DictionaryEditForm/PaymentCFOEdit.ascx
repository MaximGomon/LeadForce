<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentCFOEdit.ascx.cs" Inherits="WebCounter.AdminPanel.UserControls.DictionaryEditForm.PaymentCFOEdit" %>
