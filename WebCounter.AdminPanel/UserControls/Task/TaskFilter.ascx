<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaskFilter.ascx.cs" Inherits="WebCounter.AdminPanel.UserControls.Task.TaskFilter" %>
...
<div class="task-filter clearfix">
    ...
    <div class="row row-responsible">
        ...
        <uc:ContactComboBox runat="server" AutoPostBack="true" ID="ucResponsible" Width="167px" FilterByFullName="true" />
    </div>
</div>