<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SelectEventTime.ascx.cs" Inherits="WebCounter.AdminPanel.UserControls.Task.SelectEventTime" %>
...
<telerik:RadScheduler ID="rScheduler"
                          ...
                          CustomAttributeNames="ResponsibleID"
						...
						<AdvancedEditTemplate>
						    <scheduler:AdvancedForm runat="server" ID="AdvancedEditForm1" Mode="Edit" Subject='<%# Bind("Subject") %>'
							    Start='<%# Bind("Start") %>' End='<%# Bind("End") %>' ResponsibleID='<%# Bind("ResponsibleID") %>' />
						</AdvancedEditTemplate>
