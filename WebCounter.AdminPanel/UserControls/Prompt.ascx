<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Prompt.ascx.cs" Inherits="WebCounter.AdminPanel.UserControls.Prompt" %>
...
console.log(lastShownButton);
    ...
    <telerik:RadPanelBar ID="RadPanelBar1" Width="189px" Skin="Windows7" runat="server">
        <Items>
            <telerik:RadPanelItem Expanded="true" Text="Подсказка">
                <ContentTemplate>
