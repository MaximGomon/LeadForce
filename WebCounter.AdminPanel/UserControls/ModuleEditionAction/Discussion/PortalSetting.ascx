<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PortalSetting.ascx.cs" Inherits="WebCounter.AdminPanel.UserControls.ModuleEditionAction.Discussion.PortalSetting" %>
    ...
    <tr>
        ...
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">    
            ...
            <div class="portal-settings">
                ...
                <asp:Panel runat="server" ID="plPortalLink" CssClass="row" Visible="false">
                    <label>Ссылка на портал:</label>
                    <asp:HyperLink runat="server" ID="hlPortalLink" Target="_blank" />
                </asp:Panel>
                <div class="row">
