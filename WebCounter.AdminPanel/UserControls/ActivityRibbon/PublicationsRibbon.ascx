<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PublicationsRibbon.ascx.cs" Inherits="WebCounter.AdminPanel.UserControls.ActivityRibbon.PublicationsRibbon" %>
<%@ Register TagPrefix="labitec" Namespace="WebCounter.AdminPanel.UserControls.ActivityRibbon.Code" Assembly="WebCounter.AdminPanel" %>
<%@ Register TagPrefix="uc" TagName="PublicationFilter" Src="~/UserControls/ActivityRibbon/PublicationFilter.ascx" %>
        ...
        <ItemTemplate>
            <div class="item" id='<%# Eval("ID") %>'>
                ...
                <div class="publication-container">
                    <h3 class="title"><a href="javascript:;" onclick='InitAndShowPublicationPopup("<%# Eval("ID") %>")'><%# Eval("Title") %></a></h3>
                    ...
                    <br/>
                    <div class="stats" id='<%# "stats" + Eval("ID") %>'>
                        <ul>
    ...
    <labitec:RadListViewClientBindingExtender runat="server" ID="rlvcbePublications" TargetControlID="rlvPublications">
        <ClientItemTemplate>
            <div class="item" id='{%= ID %}'>
                ...
                <div class="publication-container">
                    <h3 class="title"><a href="javascript:;" onclick='InitAndShowPublicationPopup("{%= ID %}")'>{%= Title %}</a></h3>
                    ...
                    <ul class="operations">                    
                        ...
                        <li class="date">{%= FormattedDate %}<span>&nbsp;</span></li>
        ...
        <div class="comment-item" id="comment{%= ID %}">
            ...
            <ul class="comment-operations">
                ...
                {% if (isOfficialAnswer != true) { %}
                    <li class="official-answer"><a href="javascript:;" onclick="CheckOfficialAnswer(this, '{%= ID %}', '{%= PublicationID %}')">Официальный ответ</a></li>
                {% } %}
                <li class="edit"><a href="javascript:;" title="Редактировать" onclick="EditComment('{%= ID %}')"><span>Редактировать</span></a></li>
                <li class="delete"><a href="javascript:;" title="Удалить" onclick="DeleteComment('{%= ID %}', '{%= PublicationID %}')"><span>Удалить</span></a></li>
            </ul>
