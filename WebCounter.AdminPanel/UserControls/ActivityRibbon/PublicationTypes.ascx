<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PublicationTypes.ascx.cs" Inherits="WebCounter.AdminPanel.UserControls.ActivityRibbon.PublicationTypes" %>
