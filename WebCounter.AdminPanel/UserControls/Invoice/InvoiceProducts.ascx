<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InvoiceProducts.ascx.cs" Inherits="WebCounter.AdminPanel.UserControls.Invoice.InvoiceProducts" %>
...
<telerik:RadAjaxPanel runat="server" ID="ajaxPanel">
	<telerik:RadGrid ID="rgInvoiceProducts" runat="server" OnItemDataBound="rgInvoiceProducts_OnItemDataBound" OnNeedDataSource="rgInvoiceProducts_NeedDataSource" Skin="Windows7" AllowPaging="True" PageSize="20" AllowSorting="True" AutoGenerateColumns="False"  ShowStatusBar="true" HorizontalAlign="NotSet"
	 OnDeleteCommand="rgInvoiceProducts_DeleteCommand" OnInsertCommand="rgInvoiceProducts_InsertCommand" OnUpdateCommand="rgInvoiceProducts_UpdateCommand">
							...
							<div class="two-columns order-product">
							    <div class="left-column">                        						
								    <div class="row row-dictionary">
									    <label>Продукт:</label>
									    <uc:DictionaryComboBox runat="server" ID="dcbProducts" AutoPostBack="true" OnSelectedIndexChanged="dcbProducts_OnSelectedIndexChanged"  ValidationErrorMessage="Вы не выбрали продукт" ValidationGroup="groupUpdateInvoiceProduct"  DictionaryName="tbl_Product" DataTextField="Title" ShowEmpty="true" Width="230px" />
								    </div>
                                </div>
								...
								<div class="left-column">
									<div class="row">
										...
										<asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="rntxtQuantity" CssClass="required" Text="*" ErrorMessage="Вы не ввели количество" ValidationGroup="groupUpdateInvoiceProduct" runat="server" />
									</div>
									<div class="row">
										<label>Валюта:</label>
										<uc:DictionaryComboBox runat="server" ID="dcbCurrency" ValidationGroup="groupUpdateInvoiceProduct" ValidationErrorMessage="Вы не выбрали валюту" DictionaryName="tbl_Currency" DataTextField="Name" ShowEmpty="true" Width="220px"/>
									</div>                            
									<div class="row">
										...
										<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="rntxtCurrencyPrice" CssClass="required" Text="*" ErrorMessage="Вы не ввели цену в валюте" ValidationGroup="groupUpdateInvoiceProduct" runat="server" />
									</div>
									<div class="row row-dictionary">
										...
										<asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="rntxtCurrencyAmount" CssClass="required" Text="*" ErrorMessage="Вы не ввели сумму в валюте" ValidationGroup="groupUpdateInvoiceProduct" runat="server" />
									</div>
								</div>
								<div class="right-column">
									<div class="row row-dictionary">
										<label>Единица измерения:</label>
										<uc:DictionaryComboBox runat="server" ID="dcbUnit" ValidationGroup="groupUpdateInvoiceProduct" ValidationErrorMessage="Вы не выбрали единицу измерения" DictionaryName="tbl_Unit" DataTextField="Title" ShowEmpty="true" Width="220px" />
									</div>
									<div class="row">
										<label>Курс:</label>
										...
										<asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="rntxtRate" CssClass="required" Text="*" ErrorMessage="Вы не ввели курс" ValidationGroup="groupUpdateInvoiceProduct" runat="server" />
									</div>
									<div class="row">
										<label>Цена:</label>
										...
										<asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="rntxtPrice" CssClass="required" Text="*" ErrorMessage="Вы не ввели цену" ValidationGroup="groupUpdateInvoiceProduct" runat="server" />
									</div>
									<div class="row">
										<label>Сумма:</label>
										...
										<asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="rntxtAmount" CssClass="required" Text="*" ErrorMessage="Вы не ввели сумму" ValidationGroup="groupUpdateInvoiceProduct" runat="server" />
									</div>  
								</div>
								<div class="clear"></div>
								<h3>Скидки</h3>
								...
								<div class="left-column">
									<div class="row">
										...
										<asp:RequiredFieldValidator ID="RequiredFieldValidator7" ControlToValidate="rntxtCurrencyTotalAmount" CssClass="required" Text="*" ErrorMessage="Вы не ввели иотого в валюте" ValidationGroup="groupUpdateInvoiceProduct" runat="server" />
									</div>
								</div>
								<div class="right-column">
									<div class="row">
										...
										<asp:RequiredFieldValidator ID="RequiredFieldValidator8" ControlToValidate="rntxtTotalAmount" CssClass="required" Text="*" ErrorMessage="Вы не ввели иотого" ValidationGroup="groupUpdateInvoiceProduct" runat="server" />
									</div>
								</div>
								<div class="clear"></div>						
							<br/>
							<div class="buttons clearfix">
								<asp:LinkButton ID="lbtnSave" ValidationGroup="groupUpdateInvoiceProduct" CommandName='<%# (Container is GridEditFormInsertItem) ? "PerformInsert" : "Update" %>' CssClass="btn" runat="server"><em>&nbsp;</em><span>Сохранить</span></asp:LinkButton>
