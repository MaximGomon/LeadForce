...
{
    public partial class Publication : LeadForceBasePage
    {
        ...
        private void BindData()
        {
            ...
            if (publicationData != null)
            {
                ...
                rcbPublicationType.SelectedIndex = rcbPublicationType.Items.IndexOf(rcbPublicationType.Items.FindItemByValue(publicationData.PublicationTypeID.ToString()));
        ...
        protected void lbDeleteFile_Click(object sender, EventArgs e)
        {
            ...
            if (((LinkButton)sender).CommandArgument != null && ((LinkButton)sender).CommandArgument != Guid.Empty.ToString())
            {
                ...
                if (!string.IsNullOrEmpty(((LinkButton)sender).CommandArgument))
                    fsp.Delete(CurrentUser.Instance.SiteID, "Publications", ((LinkButton)sender).CommandArgument, FileType.Attachment);
            }
