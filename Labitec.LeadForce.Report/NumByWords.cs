...
namespace Labitec.LeadForce.Report
{
    public class NumByWords
    {
        ...
        /// <param name="word234">The word234.</param>
        /// <param name="wordmore">The wordmore.</param>
        /// <param name="sword1">The sword1.</param>
        /// <param name="sword234">The sword234.</param>
        /// <param name="swordmore">The swordmore.</param>
        /// <returns></returns>
        ...
        /// Ends the th.
        /// </summary>
        /// <param name="ThNum">The th num.</param>
        /// <param name="Dek">The dek.</param>
        /// <returns></returns>
