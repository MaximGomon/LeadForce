<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SaveTaskDuration.ascx.cs" Inherits="Labitec.LeadForce.Portal.Main.TaskModule.UserControls.SaveTaskDuration" %>
