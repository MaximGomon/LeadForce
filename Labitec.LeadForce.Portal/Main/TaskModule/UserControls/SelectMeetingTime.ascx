<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SelectMeetingTime.ascx.cs" Inherits="Labitec.LeadForce.Portal.Main.TaskModule.UserControls.SelectMeetingTime" %>

<%@ Register TagPrefix="scheduler" TagName="AdvancedForm" Src="~/Main/TaskModule/UserControls/AdvancedForm.ascx" %>
