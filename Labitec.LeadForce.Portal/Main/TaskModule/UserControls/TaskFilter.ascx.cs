...
namespace Labitec.LeadForce.Portal.Main.TaskModule.UserControls
{
    ...
    {
        protected const string TaskWidgetFilterClassName = "Labitec.LeadForce.Portal.TaskWidgetFilter";
    ...
    public class TaskFilterSettings
    {
        ...
        {
            return string.Format("{0}${1}", this.StartDate.ToString("yyyy-MM-dd"), this.EndDate.ToString("yyyy-MM-dd"));
        }
